...
class LoginController: UIViewController {
    ...
    @IBAction func login(_ sender: Any) {
        ...
        //let urlString = "http://10.219.0.15:8080/FinalProject/loginPro.jsp" + "?id=" + id + "&passwd=" + passwd
        ...
        AF.request(encodedUrlString).responseString(encoding: .utf8) { response in
            ...
            case .success(var str):
                ...
                if str.contains("0") || str.contains("-1") {
                    let alertController = UIAlertController(title:"로그인 실패", message: "다시 입력하세요~", preferredStyle: UIAlertController.Style.alert)
                    ...
                    let scheduleController = storyBoard.instantiateViewController(withIdentifier: "Schedule") as! StockController
